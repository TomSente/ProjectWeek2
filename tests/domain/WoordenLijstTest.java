...
public class WoordenLijstTest {
    ...
    @Test
    public void Test_getAantalWoorde_geeft_bij_lege_lijst_0() {
        WoordenLijst woordenlijstLeeg = new WoordenLijst();
        assertEquals(0,woordenlijstLeeg.getAantalWoorden());
    }

    @Test
    public void Test_voeg_toe_Voegt_1_woord_toe() {
    ...
    @Test
    public void getRandom_geef_woord_dat_in_list_zit(){
    assertTrue(woordenlijstMetGeldigeWoorden.getWoordenLijst().contains(woordenlijstMetGeldigeWoorden.getRandomWoord()));
    }
